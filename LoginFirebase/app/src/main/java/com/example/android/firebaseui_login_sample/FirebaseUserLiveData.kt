...
class FirebaseUserLiveData : LiveData<FirebaseUser?>() {
    ...
    /*
        TODO: set the value of this FireUserLiveData object by hooking it up to equal the value
         of the current FirebaseUser. You can utilize the FirebaseAuth.AuthStateListener
         callback to get updates on the current Firebase user logged into the app.
     */
