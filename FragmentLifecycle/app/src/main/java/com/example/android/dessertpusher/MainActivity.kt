...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Add an info level log statement here
        ...
        if (savedInstanceState != null) {
            // get all game state information from the bundle and set it
        ...
        // Set the TextViews (UI) to the right values
    ...
    // Restore data when user returns to app
    ...
    // Store data when user temporarily exits app
    ...
    // Override the onStart lifecycle method and add an info level log statement
