...
// Use this file to hold the Network Layer
...
//    .addConverterFactory(ScalarsConverterFactory.create())
    // Use .addCallAdapterFactory to add the CoroutineCallAdapterFactory
        // Enables Retrofit to produce a coroutine-based API.
        // CallAdapters add the ability for Retrofit to create API's that return something other than the default call class.
...
interface MarsApiService {
    ...
    fun getProperties(@Query("filter") type: String):
            // Change the return type from our getProperties call to Deferred
            Deferred<List<MarsProperty>>
                // A Deferred is a kind of coroutine job that can directly return a result
