...
class ClippedView @JvmOverloads constructor(
    ...
    // create and initialize a rectangle variable. RectF is a class that holds rectangle coordinates in floating point.
    ...
    private fun drawClippedRectangle(canvas: Canvas) {
        /*
        Inside the drawClippedRectangle() method, set the boundaries of the clipping rectangle for
        the whole shape. Apply a clipping rectangle that constrains to drawing only the square.
         */
        /*
        ...
        There are a lot of variants of the clipRect() method that accept different forms of regions
        and allow different operations on the clipping rectangle. Check the linked documentation to
        learn more.
         */
        canvas.clipRect(
        ...
        /*
        Note: The Paint.Align property specifies which side of the text to align to the origin (not
        which side of the origin the text goes, or where in the region it is aligned!). Aligning the
        right side of the text to the origin places it on the left of the origin.
         */
    ...
    // Add the following drawQuickRejectExample() function to ClippedView, and uncomment its invocation in onDraw(). Read the code, as it contains everything you need to know to use quickReject().
